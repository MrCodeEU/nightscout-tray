...
@interface NightscoutTrayAppDelegate: NSObject <NSApplicationDelegate>
...
@implementation NightscoutTrayAppDelegate {
...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
  ...
  //[self->menu setDelegate:(NightscoutTrayAppDelegate *)self];
...
NightscoutTrayAppDelegate *owner;
...
void registerSystray(void) {
  ...
  owner = [[NightscoutTrayAppDelegate alloc] init];
